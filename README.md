...
```
INSERIRINDO DADOS DE HABILIDADES:
```
...
```
INSERIRINDO DADOS  DE EXPERIÊNCIAS:
```
...
```
INSERIRINDO DADOS DAS ATIVIDADES:
```
...
```
INSERIRINDO DADOS DA TABELA ASSOCIATIVA EXPERIENCIA_ATIVIDADE:
```
